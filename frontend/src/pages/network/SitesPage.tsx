      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Physical locations resources are deployed at. Hierarchical: a campus
            site can have building / floor sites under it. Distinct from CMDB —
            no rack / U / floor-plan tracking.
          </p>
        </div>
