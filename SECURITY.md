...
Please report security vulnerabilities by opening a [GitHub Security Advisory](https://github.com/spatiumnorth/spatiumddi/security/advisories/new) on the repository.
