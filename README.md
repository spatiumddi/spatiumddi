...
- 🤖 **Operator Copilot** — AI assistant grounded in your live IPAM / DNS / DHCP / Network data. Hosted-API or fully on-prem (Ollama). One provider config, **186 tools**, real conversations about your network.
  ...
  **Tool registry (186 tools — highlights below)**
