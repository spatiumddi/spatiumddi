...
| ✂️ | **Subnet operations** | Split · Merge · Find-free — preview-then-commit with typed-CIDR confirm |
| 🌐 | **DNS** | BIND9 container, auto-registering · RFC 2136 dynamic updates · per-server zone-serial drift |
| 🔄 | **DHCP** | Kea container · group-centric Kea HA (load-balanced or hot-standby) with self-healing peer drift |
