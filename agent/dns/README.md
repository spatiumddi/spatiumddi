...
Sidecar agent baked into the SpatiumDDI managed DNS container images
(`ghcr.io/spatiumddi/dns-bind9`, `ghcr.io/spatiumddi/dns-powerdns`).
...
| `AGENT_DRIVER` | `bind9` or `powerdns` |
